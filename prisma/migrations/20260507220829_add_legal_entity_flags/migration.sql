...
CREATE TABLE "new_Recipient" (
    ...
    "isLegalEntity" BOOLEAN NOT NULL DEFAULT true,
    "name" TEXT NOT NULL,
    "company" TEXT,
    "email" TEXT,
    "street" TEXT,
...
INSERT INTO "new_Recipient" ("city", "company", "country", "createdAt", "email", "id", "name", "postalCode", "street") SELECT "city", "company", "country", "createdAt", "email", "id", "name", "postalCode", "street" FROM "Recipient";

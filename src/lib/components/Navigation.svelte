...
<header class="sticky top-0 z-50 border-b border-gray-200 bg-white/90 backdrop-blur">
	<div class="mx-auto max-w-6xl px-4 py-3">
		<div class="flex items-center justify-between">
			...
			<!-- Desktop Navigation -->
			<nav class="hidden gap-6 text-sm font-medium text-gray-500 lg:flex">
			...
			<!-- Desktop User Menu -->
			<form method="POST" action="/logout" class="hidden items-center gap-4 lg:flex">
		...
		<!-- Mobile Navigation -->
		{#if mobileMenuOpen}
			<div class="mt-4 border-t border-gray-200 pt-4 pb-4 lg:hidden">
				...
				<form method="POST" action="/logout" class="mt-4 border-t border-gray-200 pt-4">
					<div class="mb-3 truncate text-sm text-gray-600">{userEmail}</div>
					<button
						type="submit"
